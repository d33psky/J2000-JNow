...
int main(int argc, char **argv) {
    ...
    double JNow_ra  = iauAnp(rob - eo) * DR2D; // Convert CIO RA to equinox of date RA by subtracting the equation of the origins, Radians to degrees
    double JNow_dec = dob * DR2D;
